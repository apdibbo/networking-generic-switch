...
class TestNetmikoCumulusNVUE(test_netmiko_base.NetmikoSwitchTestBase):
    ...
    def test_delete_network(self, mock_exec):
        ...
        mock_exec.assert_called_with(
            ['net unset bridge domain br_default vlan 3333'])
    ...
    def test_plug_port_to_network(self, mock_exec):
        ...
        mock_exec.assert_called_with(
            ['nv set interface 3333 link state up',
             'nv unset interface 3333 bridge domain br_default untagged 123',
             'nv set interface 3333 bridge domain br_default untagged 33'])
    ...
    def test_delete_port(self, mock_exec):
        ...
        mock_exec.assert_called_with(
            ['nv unset interface 3333 bridge domain br_default untagged 33',
             'nv set bridge domain br_default vlan 123',
             'nv set interface 3333 bridge domain br_default untagged 123',
    ...
    def test_plug_bond_to_network(self, mock_exec):
        ...
        mock_exec.assert_called_with(
            ['nv set interface bond 3333 link state up',
             'nv unset interface bond 3333 bridge domain br_default untagged 123',
             'nv set interface bond 3333 bridge domain br_default untagged 33'])
    ...
    def test_unplug_bond_from_network(self, mock_exec):
        ...
        mock_exec.assert_called_with(
            ['nv unset interface bond 3333 bridge domain br_default untagged 33',
             'net add vlan 123',
             'nv set interface bond 3333 bridge domain br_default untagged 123',
    ...
    def test_save(self):
        ...
        mock_connect.send_command.assert_called_with('nv config apply')
